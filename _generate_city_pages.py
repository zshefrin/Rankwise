...
{{
  ...
  "mainEntity": [
    ...
    {{"@type":"Question","name":"Am I locked into a contract?","acceptedAnswer":{{"@type":"Answer","text":"No long-term contracts. It's month to month: cancel any time, with no notice period, and service runs to the end of the month you've paid for."}}}},
  ...
  <div class="container">
    ...
    <div class="results-grid">
      <article class="result-main reveal in">
        <h3>How the first 90 days are sequenced</h3>
        <div class="timeline">
          <div><strong>First 30 days</strong>Profile, categories, service area and directory listings are cleaned up, and review requests start going out.</div>
          <div><strong>Days 30 to 90</strong>Posts, job photos and reviews keep arriving, and your position is checked against the starting point we wrote down.</div>
          <div><strong>After month 3</strong>The work extends to more searches and nearby cities where your plan includes them.</div>
        </div>
      </article>
...
<section class="faq" id="faq">
  <div class="container faq-wrap">
    ...
    <div class="faq-item reveal in">
      ...
      <div class="faq-a" id="faq-a-2" aria-hidden="true">No long-term contracts. It's month to month: cancel any time, with no notice period, and service runs to the end of the month you've paid for. We don't believe in trapping people.</div>
    </div>
    <div class="faq-item reveal in">
